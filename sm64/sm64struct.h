...
struct MObject           /* Regular objects, Mario also has its own struct like this */
{
    ...
    u32    _0x13c;
    u32    _0x140;                 /* 0x140 */
    u32    behav_param2;            /* behav param */
    u32    subaction;
    u32    action;
    u32    subsubaction;                 /* 0x150 = also reset when action changes */
    u32    timer;                  /* always incremented. When action changes, it's set to 0 */
    float  _0x158;                 
    float  distance_from_mario;
    u32    _0x160;                 /* 0x160 */
    triplet posInit;
    float  movementSpeed;                 /* 0x170 */
    float  _0x174;
    u32    _0x178;
    u32    transparency;

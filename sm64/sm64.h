...
#define M64_GFX_OBJ_PTR             (*(MObject**)0x8032DF00)
...
#define M64_CURRENT_LEVEL_ID        *(short*)0x8032ddf8 /* u16 */
...
extern short SM64Health;

extern short WarpType, WarpId;
void WarpSetUp(Mario*, int type);

extern char ParallelLakituState;
extern char ParallelLakituType;
extern short ParallelLakituAngle;

extern short SM64Music;

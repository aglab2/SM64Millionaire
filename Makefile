...
CPP_FILES = main global MillCtl warp ColorPads NumbersInput NumbersWriter World DynamicLetters GfxTable StringFit Memes Colors RainbowColors DeathRoom Scores Music
ROM = mill.z64
INCLUDE_PATH = C:\n64chain\sm64
LIBRARY_PATH = C:\n64chain\ld
